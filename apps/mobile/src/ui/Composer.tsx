  ...
  return (
    <View className="relative justify-center">
      <TextInput
        ...
        editable={!busy}
        placeholder={busy ? 'Working it out…' : 'Ask about your money'}
        placeholderTextColor={color.inkHint}
        returnKeyType="send"
        maxLength={500}
        accessibilityLabel="Ask Uday a question"
        style={{ height: control.height, paddingRight: control.sendSize + inset * 2 }}
        ...
        // disappeared into the surface it was supposed to be a well in.
        className="rounded-pill border border-hairline bg-surface-raised px-lg text-body font-normal text-ink"
      />
