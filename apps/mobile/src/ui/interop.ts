...
import { registerAnimated } from '~/ui/animated-interop'
...
// Reanimated's `Animated.View` and `Animated.Text`, and the press-scale pressable behind every
// tappable surface (a Reanimated wrapper around a core component is still a library component as
// far as NativeWind is concerned). On a phone these need more than a registration: see
// `animated-interop.native.ts`.
registerAnimated()
