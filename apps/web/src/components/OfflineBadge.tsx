  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={onRetry}
        disabled={busy}
        className="ds-press h-9 shrink-0 whitespace-nowrap rounded-pill border-[1.5px] border-solid border-accent bg-white px-3 text-[13px] font-semibold text-accent-text disabled:opacity-60"
      >
